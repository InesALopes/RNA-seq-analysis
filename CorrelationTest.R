...
CON_M1_up=scan("C:/path/to/files/here/up_regulatedgenes_CONM1.txt", character(), quote="")
CON_M1_down=scan("C:/path/to/files/here/down_regulatedgenes_CONM1.txt", character(), quote="")
CON_M2_up=scan("C:/path/to/files/here/up_regulatedgenes_CONM2.txt", character(), quote="")
CON_M2_down=scan("C:/path/to/files/here/down_regulatedgenes_CONM2.txt", character(), quote="")
M1_M2_up=scan("C:/path/to/files/here/up_regulatedgenes_M1M2.txt", character(), quote="")
M1_M2_down=scan("C:/path/to/files/here/down_regulatedgenes_M1M2.txt", character(), quote="")
M1_Ab_up=scan("C:/path/to/files/here/up_regulatedgenes_M1Ab.txt", character(), quote="")
M1_Ab_down=scan("C:/path/to/files/here/down_regulatedgenes_M1Ab.txt", character(), quote="")
M2_Ab_up=scan("C:/path/to/files/here/up_regulatedgenes_M2Ab.txt", character(), quote="")
M2_Ab_down=scan("C:/path/to/files/here/down_regulatedgenes_M2Ab.txt", character(), quote="")
...
CON_M1_upgenes=scan("C:/path/to/files/here/up_regulatedgenes_CONM1.txt", character(), quote="")
Ab_M1_downgenes=scan("C:/path/to/files/here/down_regulatedgenes_M1Ab.txt", character(), quote="")
CON_M1_downgenes=scan("C:/path/to/files/here/down_regulatedgenes_CONM1.txt", character(), quote="")
Ab_M1_upgenes=scan("C:/path/to/files/here/up_regulatedgenes_M1Ab.txt", character(), quote="")
CON_M2_upgenes=scan("C:/path/to/files/here/up_regulatedgenes_CONM2.txt", character(), quote="")
Ab_M2_downgenes=scan("C:/path/to/files/here/down_regulatedgenes_M2Ab.txt", character(), quote="")
CON_M2_downgenes=scan("C:/path/to/files/here/down_regulatedgenes_CONM2.txt", character(), quote="")
Ab_M2_upgenes=scan("C:/path/to/files/here/up_regulatedgenes_M2Ab.txt", character(), quote="")
M1_M2_upgenes=scan("C:/path/to/files/here/up_regulatedgenes_M1M2.txt", character(), quote="")
M1_M2_downgenes=scan("C:/path/to/files/here/down_regulatedgenes_M1M2.txt", character(), quote="")
